package com.cropster.roastingsimulation.greencoffee.entity;
...
@Entity
@Table(name = "green_coffees", schema = "cropster", uniqueConstraints =
@UniqueConstraint(name = "unique_name_per_facility", columnNames ={"facility_id","name"}))
